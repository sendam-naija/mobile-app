...
export default function GroupCollectionDetailScreen() {
  return <SafeAreaView className="flex-1 bg-white"><TopBar title="Weekend Getaway 🏖️" showBack onBackPress={() => router.replace("/groups")} /><ScrollView className="px-[19px]" contentContainerStyle={{ paddingTop: 16, paddingBottom: 30 }}>
