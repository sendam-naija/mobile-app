...
export default function ReferralRewardsScreen() {
  ...
  return <SafeAreaView className="flex-1 bg-white"><TopBar title="Refer & Earn" showBack onBackPress={() => router.replace("/dashboard")} /><ScrollView className="px-[19px]" contentContainerStyle={{ paddingTop: 16, paddingBottom: 28 }}>
