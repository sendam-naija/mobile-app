    ...
    <SafeAreaView className="flex-1 bg-white">
      ...
      >
        ...
        {open ? (
          <View className="mt-[5px] rounded-[14px] border border-mist px-[10px] pb-[8px]">
            <TextInput
              ...
              autoCapitalize="none"
              autoCorrect={false}
              className="my-[8px] h-[40px] rounded-[10px] px-[14px] font-SR"
              style={{
                backgroundColor: ThemeColors.snow,
        ...
        <TextInput
          ...
          placeholderTextColor={ThemeColors.sage}
          className="h-[58px] rounded-[14px] border border-mist px-[15px] font-SR text-[16px]"
          style={{
            backgroundColor: ThemeColors.snow,
            color: ThemeColors.deepGreen,
          }}
        />
        <View
          className="mt-[14px] flex-row rounded-[14px] border px-[14px] py-[12px]"
          style={{
